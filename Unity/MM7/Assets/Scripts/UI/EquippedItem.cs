...
public class EquippedItem : MonoBehaviour, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler {
	...
	void Start () {
        ...
        equippedItemsUI = GetComponentInParent<EquippedItemsUI>();
	}
    ...
    {
        equippedItemsUI.OnEquippedItemPointerDown(Item, eventData, this);
    }
